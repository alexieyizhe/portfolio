...
var PoseElement = (function (_super) {
    ...
    PoseElement.prototype.render = function () {
        ...
        return (React.createElement(PoseParentContext.Provider, { value: this.childrenHandlers }, React.createElement(elementType, tslib_1.__assign({}, this.getSetProps(), this.getRefs()), children)));
    };
    return PoseElement;
}(React.PureComponent));
...
var createComponentFactory = function (key) {
    var componentFactory = function (poseConfig) {
        ...
        return function (_a) {
            ...
            return !withParent || props.parentValues ? (React.createElement(PoseElement, tslib_1.__assign({ poseConfig: poseConfig, elementType: key }, props))) : (React.createElement(PoseParentContext.Consumer, null, function (parentCtx) { return (React.createElement(PoseElement, tslib_1.__assign({ poseConfig: poseConfig, elementType: key }, props, parentCtx))); }));
        };
    };
...
var PoseGroup = (function (_super) {
    ...
    PoseGroup.getDerivedStateFromProps = function (props, _a) {
        ...
        return {
            ...
            children: handleIncomingChildren(tslib_1.__assign({}, props, { incomingChildren: incomingChildren, displayedChildren: children, isLeaving: isLeaving,
